...
export declare function getProviderInfoFromChecksArray(
  checks: string[],
): IProviderInfo;
export declare function getProviderInfoByName(
  name: string | null,
): IProviderInfo;
export declare function getProviderInfoById(id: string | null): IProviderInfo;
export declare function getProviderInfoByCheck(
  check: string | null,
): IProviderInfo;
export declare function isMobile(): boolean;
export declare function getProviderDescription(
  providerInfo: Partial<IProviderInfo>,
): string;
export declare function filterMatches<T>(
  array: T[],
  condition: (x: T) => boolean,
  fallback: T | undefined,
): T | undefined;
export declare function filterProviders(
  param: string,
  value: string | null,
): IProviderInfo;
...
export declare function findMatchingRequiredOptions(
